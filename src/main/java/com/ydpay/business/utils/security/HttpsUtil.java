...
public class HttpsUtil {
     ...
     * @throws IOException
     */
    public static String doTokenSslPost(String token,String url, Map<String, Object> urlParamMap, String charset)
            throws NoSuchAlgorithmException, KeyManagementException,
            IOException {
        ...
        conn.connect();
        DataOutputStream out = new DataOutputStream(conn.getOutputStream());
        out.writeBytes(urlencode(urlParamMap));
        // 刷新、关闭
        out.flush();
        out.close();
        InputStream is = conn.getInputStream();
